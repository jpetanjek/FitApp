...
public class DebugRunningInstructor extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_debug_running_instructor);
        ...
        GraphView graph = (GraphView) this.findViewById(R.id.graphGornji);
        ...
        GraphView graph2 = (GraphView) this.findViewById(R.id.graphDonji);

...
public class NamirniceDoruckaViewModel extends AndroidViewModel {
    private LiveData<List<NamirniceObroka>>  namirniceObrokas;
    private Context context;

    public NamirniceDoruckaViewModel(@NonNull Application application) {
        super(application);
        this.context = application;
        namirniceObrokas = NamirnicaDAL.DohvatiSveNamirniceObroka("Breakfast", application);
    }

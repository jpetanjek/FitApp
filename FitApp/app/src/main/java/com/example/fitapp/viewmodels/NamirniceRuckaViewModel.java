...
public class NamirniceRuckaViewModel extends AndroidViewModel {

    private LiveData<List<NamirniceObroka>> namirniceObrokas;
    private Context context;

    public NamirniceRuckaViewModel(@NonNull Application application) {
        super(application);
        this.context = application;
        namirniceObrokas = NamirnicaDAL.DohvatiSveNamirniceObroka("Lunch", application);
    }
